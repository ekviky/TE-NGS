...
Contains example output files
	NA12878_TE-NGS_calls_annotated_v0.1.bed # all TE calls made for NA12878, results described in manuscript

Requirements
------------

TE-NGS is implemented in R and distributed using packrat for management of packages and dependencies. The snapshot is built on R version 3.1.2. 
...
The R script requires the following inputs:
	...
	- mode # one of [test,sample] indicating the run mode: test to generate TE calls on NA12878 bams provided in /test; sample for generating TE calls on sample of interest processed by TE-NGS workflow
